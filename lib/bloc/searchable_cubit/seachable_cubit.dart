...
part 'seachable_state.dart';

class SeachableCubit extends Cubit<SeachableState> {
  SeachableCubit() : super(SeachableInitial()) {
    _loadFoundedUsers();
  }
  ...
  onSearch(String search) {
    ...
    if (foundedUsers.isEmpty) {
      ...
      emit(SeachableLoaded());
    }
  }

  void _loadFoundedUsers() {
      foundedUsers = users;
      emit(SeachableLoaded());
  }

  follow({required User user}) {
    user.isFollowedByMe = !user.isFollowedByMe;
    emit(Seachablefollow());
  }
}
